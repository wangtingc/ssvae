...
class ScLSTMLayer(MergeLayer):
    ...
    def __init__(self, incoming, num_units, da_init,
        ...
        def add_gate_params(gate, gate_name):
            ...
            return (self.add_param(gate.W_in, (num_inputs, num_units),
                    ...
                    self.add_param(gate.W_hid, (num_da_units, num_units),
                                   name="W_da_to_{}".format(gate_name)),
        ...
        (self.W_in_to_cell, self.W_hid_to_cell, self.W_da_to_cell, self.b_cell,
         self.nonlinearity_cell) = add_gate_params(cell, 'cell')

        (self.W_in_to_outgate, self.W_hid_to_outgate, self.W_da_to_outgate, self.b_outgate,
    ...
    def get_output_for(self, inputs, **kwargs):
        ...
        W_da_stacked = T.concatenate(
            [self.W_da_to_ingate, self.W_da_to_forgetgate,
             self.W_da_to_cell, self.W_da_to_outgate], axis=1)
        ...
        def step(input_n, cell_previous, hid_previous, da_previous, *args):
            ...
            gates = input_n + T.dot(hid_previous, W_hid_stacked) + T.dot(da_previous, W_da_stacked)
        ...
        non_seqs = [W_hid_stacked, W_da_stacked]
